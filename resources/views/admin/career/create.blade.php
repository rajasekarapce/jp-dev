    ...
    <div class="row">
        <div class="col-md-12 qualification_panel">
            ...
            <form action="{{route('career_details')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-sm-8">
                      <select required class="form-control select2" name="academic_projtype1"  style="color: rgb(51, 51, 51);">
                ...
                <div class="col-sm-8">
                      <input required class="form-control valid" type="text"  name="xii_mark" id="marksXii" placeholder="Enter your Marks" value="{{ old('xii_mark')}}">
                ...
                <div class="col-sm-8">
                      <textarea required class="form-control valid" type="text"  name="academic_projdesc" id="academic_projdesc" placeholder="Project Description" value="{{ old('xii_mark')}}">
                      </textarea>
...
$(document).ready(function () {
    ...
    $("#add-more").click(function(e){
        ...
        var newIn = ' <div id="field'+ next +'" name="field'+ next +'"><!-- Text input--><div id="field0"><div class="form-group row "><label for="name" class="col-sm-4 control-label">@lang('Choose')</label><div class="col-sm-8"><select required class="form-control select2" name="academic_projtype'+next+'"  style="color: rgb(51, 51, 51);"><option value="">Select Academic Project</option>@foreach(\App\CareerDetail::ACADEMIC_PROJTYPE as $key => $value)<option {{ old('skill') === $key ? 'selected' : '' }} value="{{$key}}" value="{{$key}}">{{$value}}</option>@endforeach</select></div></div><div class="form-group row "><label for="name" class="col-sm-4 control-label">@lang('Title')</label><div class="col-sm-8"><input required class="form-control valid" type="text"  name="academic_projname'+next+'" id="academic_projname'+next+'"  ></div></div><div class="form-group row "><label for="name" class="col-sm-4 control-label">@lang('Description')</label><div class="col-sm-8"><textarea required class="form-control valid" type="text"  name="academic_projdesc'+next+'" id="academic_projdesc" placeholder="Project Description" ></textarea></div></div><div class="form-group"><div class="col-md-4">';
        }
