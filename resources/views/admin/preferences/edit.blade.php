        ...
        <div class="col-md-12 qualification_panel">
            ...
            <form action="{{route('education_details')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row {{ $errors->has('hq_qualid')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <select required class="form-control select2" name="hq_qualid" id="course" style="color: rgb(51, 51, 51);">
                            ...
                            <option {{ old('hq_qualid', $educationDetail->hq_qualid) === $key ? 'selected' : '' }} value="{{$qualification->id}}">{{$qualification->course}}</option>
                            @endforeach
                        </select>
                 ...
                 <div class="form-group row {{ $errors->has('hq_passmonth')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-4">
                        <select required class="form-control select2" name="hq_passmonth" id="passMonth" style="color: rgb(51, 51, 51);">
                            ...
                            <option {{ old('hq_passmonth', $educationDetail->hq_passmonth) === $key ? 'selected' : '' }} value="{{$key}}">{{$month}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row {{ $errors->has('hq_marktype')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-4">
                       <input required type="radio" onclick="setMaximum('hq_mark', 1);" name="hq_marktype" id="percentage" value="1" style="vertical-align: sub;" {{ old('hq_marktype', $educationDetail->hq_marktype) === 1 ? 'checked' : '' }} > Percentage
                        
                    </div>
                    <div class="col-sm-4">
                       <input required type="radio" onclick="setMaximum('hq_mark', 2);" name="hq_marktype" id="cgpa" {{ old('hq_marktype', $educationDetail->hq_marktype) === 2 ? 'checked' : '' }} value="2" style="vertical-align: sub;"> CGPA (out of 10)
                ...
                <div class="col-sm-8">
                      <input required class="form-control valid" type="float" step="0.01" name="hq_mark" id="marks" placeholder="Enter your Marks" min="1" max="100" value="{{ old('hq_mark', $educationDetail->hq_mark)}}">
                ...
                <div class="form-group row {{ $errors->has('name')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <select required class="form-control select2" name="hq_state" id="dropdown_hqState" style="color: rgb(51, 51, 51);">
                            ...
                            <option {{ old('hq_state', $educationDetail->hq_state) === $key ? 'selected' : '' }} value="{{$key}}" value="{{$key}}">{{$state->state_name}}</option>
                            @endforeach
                        </select>
                 ...
                 <div class="form-group row {{ $errors->has('institute')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <select required class="form-control select2" name="hq_institute" id="dropdown_hqInstitute" style="color: rgb(51, 51, 51);">
                            ...
                            <option {{ old('hq_institution', $educationDetail->hq_institute) === $institution->id ? 'selected' : '' }} value="{{$institution->id}}">{{$institution->name}}</option>
                            @endforeach
                            @endif
                ...
                <div class="form-group row {{ $errors->has('university')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <select required class="form-control select2" name="hq_university" id="dropdown_hqUniversity" style="color: rgb(51, 51, 51);">
                            ...
                            <option {{ old('hq_institution', $educationDetail->hq_university) === $university->id ? 'selected' : '' }} value="{{$university->id}}">{{$university->name}}</option>
                            @endforeach
                            @endif
                 ...
                 <div class="form-group row {{ $errors->has('xii_passmonth')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-4">
                        <select required class="form-control select2" name="xii_passmonth" id="passMonthXii" style="color: rgb(51, 51, 51);">
                            <option value="">Passout Month</option>
                            @foreach(\App\User::PASSOUT_RADIO as $key=>$month)
                            <option  {{ old('xii_passmonth', $educationDetail->xii_passmonth) === $key ? 'selected' : '' }} value="{{$key}}">{{$month}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row {{ $errors->has('xii_marktype')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-4">
                       <input onclick="setMaximum('xii_mark', 1);" type="radio" name="xii_marktype" id="percentage" value="1" style="vertical-align: sub;" {{ old('xii_marktype', $educationDetail->xii_marktype) === 1 ? 'checked' : '' }}> Percentage
                        
                    </div>
                    <div class="col-sm-4">
                       <input onclick="setMaximum('xii_mark', 2);" type="radio" name="xii_marktype" {{ old('xii_marktype', $educationDetail->xii_marktype) === 2 ? 'checked' : '' }} id="cgpa" value="2" style="vertical-align: sub;"> CGPA (out of 10)
                ...
                <div class="form-group row {{ $errors->has('xii_mark')? 'has-error':'' }}">
                    <label for="name" class="col-sm-4 control-label">@lang('Marks')</label>
                <div class="col-sm-8">
                      <input required class="form-control valid" type="float" step="0.01" min="1" max="100" name="xii_mark" id="marksXii" placeholder="Enter your Marks" value="{{ old('xii_mark', $educationDetail->xii_mark)}}">
                ...
                <div class="form-group row {{ $errors->has('xii_school')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input required placeholder="Select your School Name" class="form-control select2" name="xii_school" id="dropdown_schoolNameXii" value="{{ old('xii_school', $educationDetail->xii_school)}}" style="color: rgb(51, 51, 51);" />
                 ...
                 <div class="form-group row {{ $errors->has('xii_board')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-8">
                        <input required placeholder="Enter Board Name" class="form-control select2" name="xii_board" id="dropdown_schoolBoardXii" value="{{ old('xii_board', $educationDetail->xii_board)}}" style="color: rgb(51, 51, 51);" />
                 ...
                 <div class="form-group row {{ $errors->has('x_passmonth')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-4">
                        <select required class="form-control select2" name="x_passmonth" id="passMonthX" style="color: rgb(51, 51, 51);">
                            <option value="">Passout Month</option>
                            @foreach(\App\User::PASSOUT_RADIO as $key=>$month)
                            <option {{ old('x_passmonth', $educationDetail->x_passmonth) === $key ? 'selected' : '' }} value="{{$key}}">{{$month}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row {{ $errors->has('x_marktype')? 'has-error':'' }}">
                    ...
                    <div class="col-sm-4 {{ $errors->has('x_marktype') ? 'is-invalid' : '' }}">
                        <input style="vertical-align: sub;" type="radio" id="is_paused_{{ $key }}" name="x_marktype" value="{{ $key }}" {{ old('x_marktype', $educationDetail->x_marktype) === $key ? 'checked' : '' }} required>
                ...
                <div class="form-group row {{ $errors->has('x_mark')? 'has-error':'' }}">
                    <label for="name" class="col-sm-4 control-label">@lang('Marks')</label>
                <div class="col-sm-8">
                      <input required class="form-control valid"  name="x_mark" type="float" min="1" max="100" step="0.01" id="marksX" placeholder="Enter your Marks" value="{{ old('x_mark', $educationDetail->x_mark)}}">
                ...
                <div class="form-group row {{ $errors->has('x_school')? 'has-error':'' }}">
                    <label for="name" class="col-sm-4 control-label">@lang('School')</label>
                    <div class="col-sm-8">
                        <input required placeholder="Select your School Name" class="form-control select2" name="x_school" id="dropdown_schoolNameX" value="{{ old('x_school', $educationDetail->x_school)}}" style="color: rgb(51, 51, 51);" />
                 ...
                 <div class="form-group row {{ $errors->has('x_board')? 'has-error':'' }}">
                    <label for="name" class="col-sm-4 control-label">@lang('Board')</label>
                    <div class="col-sm-8">
                        <input required placeholder="Enter Board Name" class="form-control select2" name="x_board" id="dropdown_schoolBoardX" value="{{ old('x_board', $educationDetail->x_board)}}" style="color: rgb(51, 51, 51);" />
