               ...
               {!! e_form_error('state_id', $errors) !!}
                ...
                <div class="form-group row">
                    <div class="col-sm-offset-4 col-sm-8">
                        <button type="submit" class="btn btn-primary">@lang('app.save_new_university')</button>
                    </div>
                </div>
            ...
            <table class="table table-bordered">
                ...
                @foreach($universities as $university)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('edit_universities', $university->id) }}" class="btn btn-info"><i class="la la-pencil"></i> </a>
                            <a href="javascript:;" class="btn btn-danger category_delete" data-id="{{ $university->id }}"><i class="la la-trash"></i> </a>
                        </td>
                    </tr>
                @endforeach
            </table>
